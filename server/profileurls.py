...
urlpatterns = patterns('',
					   url(r'^volunteer/(?P<profile_id>[0-9]+)/$', ViewVolunteerFor.as_view(), name='volunteer'),
					   url(r'^editprofile/(?P<profile_id>\d+)/$', EditProfile.as_view(), name='editprofile'),
					   url(r'^newprofile', EditProfile.as_view(), name='newprofile'),
					   url(r'^managevolunteers/(?P<profile_id>\d+)/$', ViewManageVolunteers.as_view(), name='managevolunteers'),
					   url(r'^editapplicant$', EditApplicant.as_view(), name='profileeditapplicant'),
					   url(r'^viewanswers$', ViewAnswers.as_view(), name='profileviewanswers'),
					   url(r'^uploadprofileimage/(?P<profile_id>\d+)/$', UploadProfileImage.as_view(), name='uploadprofileimage'),
					   url(r'^updateprofile/(?P<profile_id>\d+)/$', UpdateProfile.as_view(), name='updateprofileinfo'),
					   url(r'^addpage/(?P<profile_id>\d+)/$', AddPage.as_view(), name='addpage'),
